...
class Generator(nn.Module):
    def __init__(self, n_classes, latentdim, batch_size, dataset_name, img_shape):
        ...
        # mi crea un dizionario di 10 elementi, ogni elemento è a sua volta un vettore di 10 elementi
        ...
        def init(input, output, normalize=True):
            ...
            if normalize:
                # do also batch normalization after a layer, then apply leakyRelu as activation function
...
class Discriminator(nn.Module):
    ...
    def forward(self, img, labels):
        ...
        if self.dataset_name == preferred_dataset:
            ...
            # associa all'immagine generata (che contiene più cifre da riconoscere) le labels che erano state richieste
